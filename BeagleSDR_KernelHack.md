...
according to am5728.pdf (page 105,106), in linux kernel dts dra74x-mmc-iodelay.dtsi, change SPI pin mux configuration
	...
	mcspi3_pins: mcspi3_pins {
		     pinctrl-single,pins = <
			       ...
			       DRA7XX_CORE_IOPAD(0x1788, PIN_INPUT_PULLUP | MUX_MODE1) /*mmc3_dat1 MCSPI3_SOMI */
		               DRA7XX_CORE_IOPAD(0x1784, PIN_OUTPUT_PULLUP | MUX_MODE1) /*mmc3_dat0 MCSPI3_MOSI */
	...
	mcspi4_pins: mcspi4_pins {
		     pinctrl-single,pins = <
		               ...
		               DRA7XX_CORE_IOPAD(0x1798, PIN_INPUT_PULLUP | MUX_MODE1) /*mmc3_dat5 MCSPI4_SOMI */
		               DRA7XX_CORE_IOPAD(0x179C, PIN_OUTPUT_PULLUP | MUX_MODE1) /*mmc3_dat6 MCSPI4_MOSI */
